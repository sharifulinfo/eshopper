...
<section class="bg_section">
	<div class="container">
		<?php 
			if (isset($msg)) {
				if ($msg==1) {
					echo "<span style='color:green;font-weight:bold;'> Category Update Successfully....... </span>";
				} else {
					echo "<span style='color:red;font-weight:bold;'> Category update Not Successfull....... </span>";
				} 
			}


		 ?>
		<form action="http://localhost/shop/Category/CategoryUpdate" method="POST">
			<table>
				<?php 
					if(isset($cat)){
						foreach ($cat as $data) {
				...
				<tr>
					...
					<td><input type="text" name="title" value="<?php echo $data['title']; ?>" required="1"></td>
				</tr>
				<tr>
					<td></td>
