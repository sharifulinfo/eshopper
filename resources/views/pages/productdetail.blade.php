		...
		<div class="product-details"><!--product-details-->
			<div class="col-sm-5">
				<div class="view-product">
					<img src="{{$result->product_img}}" alt="" height="380" width="330" />
					<h3>ZOOM</h3>
				</div>
			...
			<div class="col-sm-7">
				<div class="product-information"><!--/product-information-->
					...
					<span>
						<span>US ${{$result->product_price}}</span>
						<label>Quantity:</label>
						<form action="{{ route('addcart') }}" method="post">
							{{csrf_field()}}
							<input type="text" value="3"  name="qnt" />
					...
					<p><b>Brand:</b> {{$result->brand['brand_name']}}</p>
					<p><b>Category:</b> {{$result->category['cat_name']}}</p>
